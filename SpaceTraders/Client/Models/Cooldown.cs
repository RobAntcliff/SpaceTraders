...
namespace SpaceTraders.Client.Models {
    ...
    /// </summary>
    public class Cooldown : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new Cooldown and sets the default values.
        /// </summary>
        public Cooldown() {
        ...
        public static Cooldown CreateFromDiscriminatorValue(IParseNode parseNode) {
