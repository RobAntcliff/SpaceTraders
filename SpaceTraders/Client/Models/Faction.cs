...
namespace SpaceTraders.Client.Models {
    ...
    /// Faction details.
    /// </summary>
    public class Faction : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new Faction and sets the default values.
        /// </summary>
        public Faction() {
        ...
        public static Faction CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"symbol", n => { Symbol = n.GetEnumValue<FactionSymbol>(); } },
                {"traits", n => { Traits = n.GetCollectionOfObjectValues<FactionTrait>(FactionTrait.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<FactionSymbol>("symbol", Symbol);
            writer.WriteCollectionOfObjectValues<FactionTrait>("traits", Traits);
