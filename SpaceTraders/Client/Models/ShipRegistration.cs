...
namespace SpaceTraders.Client.Models {
    ...
    /// </summary>
    public class ShipRegistration : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new ShipRegistration and sets the default values.
        /// </summary>
        ...
        public static ShipRegistration CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"role", n => { Role = n.GetEnumValue<ShipRole>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<ShipRole>("role", Role);
