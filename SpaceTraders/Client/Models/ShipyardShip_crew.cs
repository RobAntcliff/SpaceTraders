...
namespace SpaceTraders.Client.Models {
    public class ShipyardShip_crew : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new ShipyardShip_crew and sets the default values.
        /// </summary>
        ...
        public static ShipyardShip_crew CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ShipyardShip_crew();
        }
        /// <summary>
