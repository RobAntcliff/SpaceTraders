...
namespace SpaceTraders.Client.Models {
    ...
    /// </summary>
    public class Survey : IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public Survey_size? Size { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new Survey and sets the default values.
        /// </summary>
        public Survey() {
        ...
        public static Survey CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"deposits", n => { Deposits = n.GetCollectionOfObjectValues<SurveyDeposit>(SurveyDeposit.CreateFromDiscriminatorValue)?.ToList(); } },
                {"expiration", n => { Expiration = n.GetDateTimeOffsetValue(); } },
                {"signature", n => { Signature = n.GetStringValue(); } },
                {"size", n => { Size = n.GetEnumValue<Survey_size>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<SurveyDeposit>("deposits", Deposits);
            writer.WriteDateTimeOffsetValue("expiration", Expiration);
            writer.WriteStringValue("signature", Signature);
            writer.WriteEnumValue<Survey_size>("size", Size);
