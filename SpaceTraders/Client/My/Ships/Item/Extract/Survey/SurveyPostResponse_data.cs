...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public SpaceTraders.Client.Models.Extraction? Extraction { get; set; }
#nullable restore
#else
        public SpaceTraders.Client.Models.Extraction Extraction { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"extraction", n => { Extraction = n.GetObjectValue<SpaceTraders.Client.Models.Extraction>(SpaceTraders.Client.Models.Extraction.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<SpaceTraders.Client.Models.Extraction>("extraction", Extraction);
